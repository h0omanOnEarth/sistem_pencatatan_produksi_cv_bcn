...
class MaterialReturnBloc
  ...
  MaterialReturnBloc()
      : materialRetValidationCallable = FirebaseFunctions.instance
            .httpsCallable('materialReturnValidation'),
        super(LoadingState()) {
      ...
      if (materialUsageId.isNotEmpty) {
        try {
          final HttpsCallableResult<dynamic> result =
              await materialRetValidationCallable.call(<String, dynamic>{
            'materials':
          ...
          if (result.data['success'] == true) {
            ...
            final materialReturnRef = _firestore
                .collection('material_returns')
                .doc(nextMaterialReturnId);
            ...
            final materialReturnDetailsRef =
                materialReturnRef.collection('detail_material_returns');
        ...
        if (result.data['success'] == true) {
          ...
          if (event.materialReturn.detailMaterialReturn.isNotEmpty) {
            ...
            for (var detailMaterialReturn
              ...
              final detailId =
                  event.materialReturnId + nextDetailMaterialReturnId;
