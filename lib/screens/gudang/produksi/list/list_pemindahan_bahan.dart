...
class _ListPemindahanBahanState extends State<ListPemindahanBahan> {
  final CollectionReference purchaseReqRef =
      FirebaseFirestore.instance.collection('material_transfers');
  String searchTerm = '';
          ...
          child: SingleChildScrollView(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  const CustomAppBar(
                    title: 'Pemindahan Bahan',
                    formScreen: FormPemindahanBahan(),
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final info = {
                    ...
                    'Tanggal Pemindahan': DateFormat('dd/MM/yyyy').format(
                        (data['tanggal_pemindahan'] as Timestamp).toDate()),
                      ...
                      final confirmed = await showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content: const Text(
                                "Anda yakin ingin menghapus pemindahan bahan ini?"),
                            actions: <Widget>[
                              TextButton(
                              ...
                              TextButton(
                                ...
                                onPressed: () async {
                                  final materialTransferBloc =
                                      BlocProvider.of<MaterialTransferBloc>(
                                          context);
                                  materialTransferBloc.add(
                                      DeleteMaterialTransferEvent(
                      ...
                      final confirmed = await showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content: const Text(
                                "Anda yakin ingin menyelesaikan pemindahan bahan ini?"),
                            actions: <Widget>[
                              TextButton(
                                child: const Text("Batal"),
                                onPressed: () {
