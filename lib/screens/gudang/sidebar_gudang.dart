          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildSidebarItem(3, Icons.factory, 'Produksi', iconSize: 24, isActive: selectedIndex == 4),
                _buildSidebarItem(4, Icons.report, 'Laporan', iconSize: 24, isActive: selectedIndex == 5),
                _buildSidebarItem(5, Icons.person, 'Profile', iconSize: 24, isActive: selectedIndex == 6),
              ],
            ),
          ),
      ],
