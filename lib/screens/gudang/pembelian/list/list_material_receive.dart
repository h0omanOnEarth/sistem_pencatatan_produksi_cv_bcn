...
class _ListMaterialReceiveState extends State<ListMaterialReceive> {
  final CollectionReference materialReceivesRef =
      FirebaseFirestore.instance.collection('material_receives');
              ...
              child: Column(
                ...
                children: [
                  const CustomAppBar(
                    ...
                    formScreen: FormPenerimaanBahanScreen(),
          ...
          return FutureBuilder<QuerySnapshot>(
            ...
            builder: (context, materialsSnapshot) {
              if (materialsSnapshot.connectionState ==
                ...
                return Text(
                    'Error getting material data: ${materialsSnapshot.error}');
              } else {
                ...
                final filteredDocs = itemDocs.where((doc) {
                  ...
                  final status =
                      _getMaterialStatus(materialDocs, doc['material_id']);
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final info = {
                          ...
                          'Tanggal Penerimaan': DateFormat('dd/MM/yyyy').format(
                              (data['tanggal_penerimaan'] as Timestamp)
                                  .toDate()),
                          'Catatan': data['catatan'],
                          'Jenis Bahan': _getMaterialStatus(
                              materialDocs, data['material_id']),
                          'Jumlah Permintaan':
                              data['jumlah_permintaan'].toString(),
                          'Jumlah Diterima': data['jumlah_diterima'].toString(),
                        };
                        return ListCard(
                          title: id,
                            ...
                            final confirmed = await showDialog(
                              ...
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  ...
                                  content: const Text(
                                      "Anda yakin ingin menghapus penerimaan bahan ini?"),
                                  actions: <Widget>[
                                    TextButton(
                                    ...
                                    TextButton(
                                      ...
                                      onPressed: () async {
                                        final purReqBloc = BlocProvider.of<
                                            MaterialReceiveBloc>(context);
                                        purReqBloc.add(
                                            DeleteMaterialReceiveEvent(
                                                filteredDocs[startIndex + index]
                                                    .id));
  ...
  String _getMaterialStatus(
      List<QueryDocumentSnapshot> materialDocs, String materialId) {
    final materialDoc =
        materialDocs.firstWhere((doc) => doc['id'] == materialId);
