...
class FormPengembalianPesananScreen extends StatefulWidget {
  ...
  const FormPengembalianPesananScreen(
      {Key? key, this.purchaseReturnId, this.purchaseOrderId, this.qtyLama})
      : super(key: key);
...
class _FormPengembalianPesananScreenState
    extends State<FormPengembalianPesananScreen> {
  ...
  void addOrUpdatePurchaseReturn() {
    ...
    final PurchaseReturn newPurchaseReturn = PurchaseReturn(
        id: '',
        purchaseOrderId: selectedPesanan ?? '',
        jumlah: int.tryParse(jumlahController.text) ?? 0,
        satuan: _selectedSatuan,
        alamatPengembalian: alamatPengembalianController.text,
    ...
    if (widget.purchaseReturnId != null) {
      purchaseReturnBloc.add(UpdatePurchaseReturnEvent(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        PesananPembelianDropdown(
                          kodeBahanController: kodeBahanController,
                          namaBahanController: namaBahanController,
                          namaSupplierController: supplierController,
                          tanggalPemesananController:
                              tanggalPemesananController,
                          purchaseOrderId: widget.purchaseOrderId,
                          isEnabled: widget.purchaseReturnId == null,
                        ),
                        const SizedBox(
                          height: 16.0,
                        ),
                          ...
                          children: [
                            ...
                            Expanded(
                              child: DropdownWidget(
                                label: 'Satuan',
                                selectedValue:
                                    _selectedSatuan, // Isi dengan nilai yang sesuai
                                items: const [
                                  'Kg',
                                  'Ons',
                                  'Pcs',
