              ...
              children: [
                  ...
                  onChanged: (newValue) {
                    setState(() {
                      if (!widget.productCards
                          .any((card) => card.kodeProduk == newValue)) {
                        ...
                        widget.productCardData.namaProduk =
                ...
                TextFieldWidget(
                  ...
                  controller: TextEditingController(
                      text: widget.productCardData.namaProduk),
                  isEnabled: false,
                ),
                const SizedBox(height: 8.0),
                TextFieldWidget(
                ...
                TextFieldWidget(
                  ...
                  controller: TextEditingController(
                      text: widget.productCardData.subtotal),
                  isEnabled: false,
                ),
              ],
            ),
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    padding:
                        const EdgeInsets.all(10), // Add padding to the button
