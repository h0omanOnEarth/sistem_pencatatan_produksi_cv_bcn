...
class MainLaporanAdministrasiScreen extends StatefulWidget {
  ...
  @override
  State<MainLaporanAdministrasiScreen> createState() => _MainMasterAdministrasiScreenState();
}

class _MainMasterAdministrasiScreenState extends State<MainLaporanAdministrasiScreen> {
  @override
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const CardItem(icon: Icons.shopping_cart_checkout, textA: 'Monitoring Pesanan Pelanggan', textB: 'Melihat laporan pesanan pelanggan', pageRoute: LaporanPesananPelanggan.routeName),
