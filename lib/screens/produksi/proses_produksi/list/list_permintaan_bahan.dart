...
class _ListMaterialRequestState extends State<ListMaterialRequest> {
  final CollectionReference productionOrderRef =
      FirebaseFirestore.instance.collection('material_requests');
  String searchTerm = '';
              ...
              child: Column(
                ...
                children: [
                  const CustomAppBar(
                    ...
                    formScreen: FormPermintaanBahanScreen(),
                ...
                itemBuilder: (context, index) {
                  ...
                  final info = {
                    ...
                    'Tanggal Permintaan': DateFormat('dd/MM/yyyy').format(
                        (data['tanggal_permintaan'] as Timestamp)
                      ...
                      final confirmed = await showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content: const Text(
                                "Anda yakin ingin menghapus permintaan bahan ini?"),
                            actions: <Widget>[
                              TextButton(
                              ...
                              TextButton(
                                ...
                                onPressed: () async {
                                  final productionOrderBloc =
                                      BlocProvider.of<MaterialRequestBloc>(
                                          context);
                                  productionOrderBloc.add(
                                      DeleteMaterialRequestEvent(
