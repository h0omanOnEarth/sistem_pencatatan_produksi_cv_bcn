...
class ListMaterialRequest extends StatefulWidget {
  ...
  @override
  State<ListMaterialRequest> createState() => _ListMaterialRequestState();
}

class _ListMaterialRequestState extends State<ListMaterialRequest> {
  final CollectionReference productionOrderRef = FirebaseFirestore.instance.collection('material_requests');
  String searchTerm = '';
        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                const CustomAppBar(title: 'Permintaan Bahan', formScreen: FormPermintaanBahanScreen(), routes: '${MainProduksi.routeName}?selectedIndex=2',),
...
Widget _buildMaterialRequestList() {
    ...
    builder: (context, snapshot) {
      if (snapshot.connectionState == ConnectionState.waiting) {
        ...
        final filteredDocs = itemDocs.where((doc) {
          ...
          final status = doc['status_mr'] as String;
          final tanggalRencana = doc['tanggal_permintaan'] as Timestamp; // Tanggal Pesan
                    ...
                    final confirmed = await showDialog(
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          ...
                          content: const Text("Anda yakin ingin menghapus permintaan bahan ini?"),
                          actions: <Widget>[
                            TextButton(
                            ...
                            TextButton(
                              ...
                              onPressed: () async {
                                final productionOrderBloc = BlocProvider.of<MaterialRequestBloc>(context);
                                productionOrderBloc.add(DeleteMaterialRequestEvent(paginatedDocs[index].id));
  ...
  Future<void> _showFilterDialog(BuildContext context) async {
    String? selectedValue = await showDialog<String>(
      ...
      builder: (BuildContext context) {
        return SimpleDialog(
          title: const Text('Filter Berdasarkan Status Permintaan Bahan'),
          children: <Widget>[
            SimpleDialogOption(
              onPressed: () {
