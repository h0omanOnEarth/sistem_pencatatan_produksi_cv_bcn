...
class _ListKonfirmasiProduksiState extends State<ListKonfirmasiProduksi> {
  final CollectionReference productionResultRef =
      FirebaseFirestore.instance.collection('production_confirmations');
  String searchTerm = '';
              ...
              child: Column(
                ...
                children: [
                  const CustomAppBar(
                    ...
                    formScreen: FormKonfirmasiProduksiScreen(),
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          final filteredDocs = itemDocs.where((doc) {
            ...
            final tanggalRencana =
                doc['tanggal_konfirmasi'] as Timestamp; // Tanggal Pesan
            ...
            children: [
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final info = {
                    'Tanggal Konfirmasi': DateFormat('dd/MM/yyyy').format(
                      ...
                      final confirmed = await showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content: const Text(
                                "Anda yakin ingin menghapus konfirmasi hasil produksi ini?"),
                            actions: <Widget>[
                              TextButton(
                              ...
                              TextButton(
                                ...
                                onPressed: () async {
                                  final proResBloc = BlocProvider.of<
                                      ProductionConfirmationBloc>(context);
                                  proResBloc.add(
                                      DeleteProductionConfirmationEvent(
