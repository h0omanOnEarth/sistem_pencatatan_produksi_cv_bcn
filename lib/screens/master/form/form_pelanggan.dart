...
class FormMasterPelangganScreen extends StatefulWidget {
  ...
  const FormMasterPelangganScreen({Key? key, this.customerId})
      : super(key: key);

  @override
  State<FormMasterPelangganScreen> createState() =>
      _FormMasterPelangganScreenState();
}
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(
                        height: 16.0), // Add spacing between header and cards
                    TextFieldWidget(
                            ...
                            onPressed: () {
                              ...
                              final Customer newCustomer = Customer(
                                id: widget.customerId ??
                                    '', // Gunakan widget.customerId jika ada
