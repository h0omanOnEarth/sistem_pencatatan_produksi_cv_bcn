      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          isNextButtonDisabled =
              startIndex + itemsPerPage >= filteredCustomerDocs.length;
            ...
            children: [
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final data = filteredCustomerDocs[startIndex + index].data()
                            ...
                            actions: <Widget>[
                              ...
                              TextButton(
                                ...
                                onPressed: () async {
                                  ...
                                  customerBloc
                                      .add(DeleteCustomerEvent(data['id']));
                  ...
                  ElevatedButton(
                    onPressed: isNextButtonDisabled
                        ...
                        : () {
                            setState(() {
                              startIndex += itemsPerPage;
                              if (startIndex >= filteredCustomerDocs.length) {
                                startIndex =
                                    filteredCustomerDocs.length - itemsPerPage;
                              }
                            });
                          },
                    style: ElevatedButton.styleFrom(
