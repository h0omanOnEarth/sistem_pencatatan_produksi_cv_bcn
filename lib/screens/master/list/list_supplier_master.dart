            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  const CustomAppBar(
                      title: 'Supplier',
                      formScreen: FormMasterSupplierScreen(),
                      routes: '${MainAdministrasi.routeName}?selectedIndex=1',
                      routeName: FormMasterSupplierScreen.routeName),
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          isNextButtonDisabled =
              startIndex + itemsPerPage >= filterJenisDocs.length;
            ...
            children: [
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final data = filterJenisDocs[startIndex + index].data()
                    ...
                    onTap: () {
                      if (isDesktop == true) {
                        Routemaster.of(context).push(
                            '${FormMasterSupplierScreen.routeName}?supplierId=${data['id']}');
                      } else {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            ...
                            actions: <Widget>[
                              ...
                              TextButton(
                                ...
                                onPressed: () async {
                                  ...
                                  supplierBloc
                                      .add(DeleteSupplierEvent(data['id']));
                        ...
                        : () {
                            setState(() {
                              ...
                              if (startIndex >= filterJenisDocs.length) {
                                startIndex =
                                    filterJenisDocs.length - itemsPerPage;
                              }
                            });
                          },
                    style: ElevatedButton.styleFrom(
