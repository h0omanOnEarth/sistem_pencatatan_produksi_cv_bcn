...
exports.deliveryOrderValidate = async (req) => {
    ...
    const customerOrdersRef = admin.firestore().collection("customer_orders").doc(customerOrderId);
    ...
    return { success: false, message: "Terjadi kesalahan dalam validasi pesanan pengiriman" };
    }
}