...
exports.customerOrderReturnValidation = async (req) => {
  ...
  if (
    ...
    return {
      success: false,
      message: "Jumlah pesanan pada detail harus di atas 0",
    };
  }
  ...
  if (
    ...
    return {
      success: false,
      message: "Jumlah pengembalian pada detail harus di atas 0",
    };
  }
  ...
  if (
    ...
    return {
      success: false,
      message:
        "Jumlah pesanan tidak boleh lebih kecil daripada jumlah pengembalian pada detail",
    };
  }
  ...
  try {
    ...
    return {
      success: false,
      message:
        "Terjadi kesalahan dalam validasi pengembalian pesanan pelanggan",
    };
  }
};
